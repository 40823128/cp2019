...
(function dartProgram() {
  ...
  Q = {
    main: function() {
      var t2,
        t1 = document,
        tempInput = H.interceptedTypeCheck(t1.querySelector("#weight"), "$isInputElement");
    ...
    call$1: function(e) {
      ...
      if (type === "K" || type === "k") {
        ...
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 2.20462, 2) + " lb");
      } else if (type === "L" || type === "l") {
        t1 = " " + H.S(number) + " lb =  ";
        if (typeof number !== "number")
          return number.$div();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSDouble_methods.toStringAsFixed$1(number / 2.20462, 2) + " kg");
      }
      return;
    },
    $signature: 18
